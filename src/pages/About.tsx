      ...
      <main id="main-content" className="min-h-screen">
        ...
        <section className="py-16 px-4" aria-labelledby="story-heading">
          <div className="max-w-4xl mx-auto">
            <h2 id="story-heading" className="font-serif text-2xl md:text-3xl lg:text-4xl font-light text-secondary tracking-wide mb-8 text-center">
              Our Story
            </h2>
        ...
        <section className="py-16 px-4 bg-gradient-soft" aria-labelledby="values-heading">
          <div className="max-w-5xl mx-auto">
            <h2 id="values-heading" className="font-serif text-2xl md:text-3xl lg:text-4xl font-light text-secondary tracking-wide mb-12 text-center">
              Our Values
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-background p-8 rounded-2xl shadow-soft text-center">
                <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-3xl">🌸</span>
                </div>
                <h3 className="font-serif text-xl font-medium mb-3 text-secondary">Quality First</h3>
              ...
              <div className="bg-background p-8 rounded-2xl shadow-soft text-center">
                ...
                <h3 className="font-serif text-xl font-medium mb-3 text-secondary">Family Heritage</h3>
                <p className="font-sans text-muted-foreground font-light">
              ...
              <div className="bg-background p-8 rounded-2xl shadow-soft text-center">
                ...
                <h3 className="font-serif text-xl font-medium mb-3 text-secondary">Sustainability</h3>
                <p className="font-sans text-muted-foreground font-light">
        ...
        <section className="py-16 px-4" aria-labelledby="team-heading">
          <div className="max-w-4xl mx-auto text-center">
            <h2 id="team-heading" className="font-serif text-2xl md:text-3xl lg:text-4xl font-light text-secondary tracking-wide mb-8">
              The HADAD Family
            </h2>
            ...
            <div className="bg-gradient-soft p-8 rounded-2xl">
              <blockquote className="font-serif text-xl italic text-secondary">
